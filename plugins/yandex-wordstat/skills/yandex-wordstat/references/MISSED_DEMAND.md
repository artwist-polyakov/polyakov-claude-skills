...
- Доступ к Wordstat API через ключ сервисного аккаунта по [инструкции настройки](../config/README.md)
...
- **Квота API**: при анализе множества групп следить за расходом и учитывать [актуальные квоты Wordstat](https://aistudio.yandex.ru/ru/docs/search-api/concepts/limits).
