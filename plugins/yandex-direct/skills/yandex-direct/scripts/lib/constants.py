...
# Слой со сроком в сутки. Срок не выбран, а взят из заявки на доступ, где
# частота обращений к справочникам объявлена как «не чаще раза в сутки»
# (`references/API_ACCESS.md`, раздел 3): кэш делает это заявление правдой.
LAYER = "dictionaries"
