...
В одном запросе можно указать до 10 целей. API возвращает отдельные столбцы вида `Conversions_20002_AUTO`, `ConversionRate_20002_AUTO`, `CostPerConversion_20002_AUTO`, `Revenue_20002_AUTO`. Атрибуция задаётся `--attribution`: доступны `LC`, `LSCCD`, `FCCD`, `AUTO`; по умолчанию — `LC`. Для сравнения со стратегией или интерфейсом используйте ту же модель и назовите её. [Параметры отчёта](https://yandex.ru/dev/direct/doc/ru/spec).
