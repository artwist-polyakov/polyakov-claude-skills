...
Указатель должен быть отдельным файлом, не символической или жёсткой ссылкой на другой файл: его перезапись не должна изменять содержание навыка по другим путям.
