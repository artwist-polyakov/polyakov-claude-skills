...
description: >-
  ...
  Используй, когда нужно подключить ZoomKit, проверить или настроить эти
  возможности, получить отчёты и состояние кабинетов или кампаний, либо узнать
  тарифы, баланс и счета сервиса.
---
