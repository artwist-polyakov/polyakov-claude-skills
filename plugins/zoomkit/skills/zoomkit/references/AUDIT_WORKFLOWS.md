...
Источники: [официальная спецификация ZoomKit API 1.9.0](https://zoomkit.ru/docs/api-v1.yaml) и [справка ZoomKit](https://zoomkit.ru/help). Используй этот справочник для проверок по кабинетам и кампаниям.
