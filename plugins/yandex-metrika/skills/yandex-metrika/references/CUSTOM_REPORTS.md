...
- bytime по умолчанию выбирает 7 значений dimension; параметр `top_keys` позволяет выбрать до 30. Если значений больше, используйте `/stat/v1/data` с фильтрами по каждому периоду отдельно
