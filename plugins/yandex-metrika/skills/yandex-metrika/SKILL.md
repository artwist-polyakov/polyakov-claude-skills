...
name: yandex-metrika
description: |
  Аналитика и управление Яндекс Метрикой: трафик, конверсии, UTM,
  поисковые системы, API-сегменты и доступы к счётчикам.
...
Работа с API Яндекс Метрики: отчёты, API-сегменты и прямые доступы к счётчикам.
